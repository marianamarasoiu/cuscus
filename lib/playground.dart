...
void setup() {
  // {
  //   List<List<viewmodel.CellViewModel>> spreadsheetCells = viewmodel.dataSheetbooks[0].selectedSheet.cells;
  ...
  // {
  //   List<List<viewmodel.CellViewModel>> spreadsheetCells = viewmodel.dataSheetbooks[1].selectedSheet.cells;
  ...
  //   sheet.name = 'Bars';
  //   querySelector('#sheetbook${sheet.sheet.id}-label${sheet.id}').text = sheet.name;
  // }
  ...
  // viewmodel.dataSheetbooks[0].selectedSheet.name = 'DataSheet1';
  // querySelector('#sheetbook${viewmodel.dataSheetbooks[0].id}-label${viewmodel.dataSheetbooks[0].selectedSheet.id}').text = viewmodel.dataSheetbooks[0].selectedSheet.name;
  // viewmodel.dataSheetbooks[1].selectedSheet.name = 'DataSheet2';
  // querySelector('#sheetbook${viewmodel.dataSheetbooks[1].id}-label${viewmodel.dataSheetbooks[1].selectedSheet.id}').text = viewmodel.dataSheetbooks[1].selectedSheet.name;
}
